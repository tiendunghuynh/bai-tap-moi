...
<html lang="en-US">
    <head>
        ...
        <title>Kho Sách - Kỹ Năng Trại</title>
    ...
    <body class="home blog custom-background">
        <div id="page" class="hfeed site">
            ...
            <header id="masthead" class="site-header" role="banner">
                <div class="container">
                    <div class="site-branding row">
                        ...
                        <div class="col-md-7">
                            <form class="searchform cf" style="float:right" style="position: relative;">
                        ...
                        <div class="menu-all-pages-container">
                            <ul id="menu-all-pages" class="menu">
                                <li id="menu-item-4007" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4007">
                                    <a href="http://localhost/skill/index.php?controller=homepage&action=book" style="color: #70d6bc;">Library</a>
                                </li>
                                <li id="menu-item-4017" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4017">
                                    <a href="http://localhost/skill/index.php?controller=semaphore">semaphore</a>
                                </li>
            ...
            <div class="carousel-wrapper" style="width: 80%;margin-left: 10%;">
                <div class="row  container-fluid" style="background-color:window;">
                    <div class="row container-fluid">
                        <div class="col-md-2"></div>
                        <div class="col-md-8">
                            <center><img src="http://localhost/skill/img/cau_noi_hay.jpg" style="box-shadow: wheat; margin-top: 2%;"></center><hr>
                        </div>
                        <div class="col-md-2"></div>
                    </div>
                    <?php foreach ($SESSION['list']['book'] as $key => $val) { ?>
                        <div class="col-md-2" class="form_book">
                            <a href="#" onclick="modalfunc('<?php echo $val['link'];?>','<?php echo $val['name'];?>')" data-toggle="modal" data-target="#myModal">
                                <img src="http://localhost/skill/img/<?php echo $val['img'];?>">
                                <center><p><?php echo $val['name'];?></p></center>
                            </a>
                        </div>
                    <?php if ($dem == 6) {echo '<hr>';}$dem++;} ?>
                </div>
                        ...
                        <div class="modal-dialog" style="width:80%">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <center>
                                        <iframe scrolling="no" width="1000" height="330" src="#" frameborder="0" allowfullscreen="true" id="srcmodal"></iframe>
                                    </center>
                                </div>
