...
<html lang="en-US">
    <head>
        ...
        <title>Morse - Kỹ Năng Trại</title>
        ...
        <div id="page" class="hfeed site">
                        ...
                        <div class="menu-all-pages-container">
                            <ul id="menu-all-pages" class="menu">
                                ...
                                <li id="menu-item-4020" class="menu-item menu-item-type-post_type menu-item-object-page ">
                                    <a href="http://localhost/skill/index.php?controller=morse" style="color: #FF6B6B;">Morse</a>
                                </li>
            ...
            <div class="carousel-wrapper" style="color:white;">
                <div class="carousel container">
                    <div class="row">
                        <h1 style="text-align: center; color: #505050">Morse Practice</h1>
                    </div>
                    <div class="row">
                        <h3 style="color:white">Luyện tập với bản tin của riêng bạn ^@^</h3>
                        <span for="inp">Nhập bản tin: </span>
                        <input type="text" name="inp" class="form-control input11" id="abc" />
                        <input type="submit" id="play1" class="form-control input22" value="Bắt Đầu">
                        <p id="input1"></p>
                    </div>
                </div>
                <div class="decoration-bar"></div>	
